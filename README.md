...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ttim-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15383&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ttim-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ttim` can be installed with:

```
conda install ttim
```

It is possible to list all of the versions of `ttim` available on your platform with:
